...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function Nl(){return new ii({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Do(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Z_(c){let t="SHADOWMAP_TYPE_BASIC";return c.shadowMapType===sc?t="SHADOWMAP_TYPE_PCF":c.shadowMapType===Fd?t="SHADOWMAP_TYPE_PCF_SOFT":c.shadowMapType===hr&&(t="SHADOWMAP_TYPE_VSM"),t}function J_(c){let t="ENVMAP_TYPE_CUBE";if(c.envMap)switch(c.envMapMode){case Fi:case Oi:t="ENVMAP_TYPE_CUBE";break;case ns:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Q_(c){let t="ENVMAP_MODE_REFLECTION";if(c.envMap)switch(c.envMapMode){case Oi:t="ENVMAP_MODE_REFRACTION";break}return t}function tv(c){let t="ENVMAP_BLENDING_NONE";if(c.envMap)switch(c.combine){case lc:t="ENVMAP_BLENDING_MULTIPLY";break;case np:t="ENVMAP_BLENDING_MIX";break;case ip:t="ENVMAP_BLENDING_ADD";break}return t}function ev(c){const t=c.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function nv(c,t,e,i){const o=c.getContext(),a=e.defines;let h=e.vertexShader,u=e.fragmentShader;const p=Z_(e),d=J_(e),f=Q_(e),m=tv(e),v=ev(e),x=e.isWebGL2?"":W_(e),E=j_(a),g=o.createProgram();let _,M,A=e.glslVersion?"#version "+e.glslVersion+`
